...
import { getAvailableStreamingServices, openStreamingUrl, openEmbedPlayer } from '../services/streamingService';
...
const StreamingServiceSelector = ({ 
  ...
  useEffect(() => {
    ...
    let container = document.getElementById('streaming-service-selector-portal');
    if (!container) {
      container = document.createElement('div');
      container.id = 'streaming-service-selector-portal';
  ...
  const overlayContent = (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden z-[99999999999]"
