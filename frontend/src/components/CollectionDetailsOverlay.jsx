    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-6xl h-auto max-h-[calc(100vh-1rem)] sm:max-h-[95vh] mx-4 bg-black rounded-2xl shadow-2xl flex flex-col border border-white/10 overflow-y-auto backdrop-blur-sm"
        >
          {/* Header */}
          <div className="relative">
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-10 p-2 bg-black/80 hover:bg-white/10 rounded-full transition-colors border border-white/20"
            >
