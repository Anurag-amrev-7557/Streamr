...
const BottomNav = () => {
  ...
  // Hide bottom nav when full page loader is shown (more stable than subscribing to all loading states)
  const shouldHide = fullPageLoader;
  ...
  const activeKey = useMemo(() => {
    ...
    // console.log('BottomNav: Active key changed:', { pathname: location.pathname, activeKey: result });
    return result;
  }, [location.pathname]);
  ...
  useEffect(() => {
    ...
    // Then schedule a RAF update for smooth animation
