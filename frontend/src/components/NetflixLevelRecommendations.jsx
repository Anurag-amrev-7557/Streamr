...
const NetflixLevelRecommendations = React.memo(({ 
  ...
  }, [userId, contentType, fetchRecommendations]);
      ...
      {hasMore && (
        ...
        >
          <button 
            ...
            className="px-6 py-3 text-sm font-medium text-white/80 bg-gradient-to-r from-primary to-primary/80 rounded-lg hover:from-primary/90 hover:to-primary/70 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loadingMore ? (
