    ...
    <header className="relative z-[70] flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#2b3036] px-2 pl-4 py-3 bg-gradient-to-b from-[#23272F]/90 via-[#181A20]/80 to-[#181A20]/70 backdrop-blur-[10px] shadow-xl shadow-black/10 transition-all duration-500">
      ...
      <div className="hidden sm:flex flex-1 justify-end items-center gap-2 sm:gap-3 md:gap-4 mr-2">
        ...
        <button
          ...
          className="relative inline-flex items-center justify-center w-11 h-11 rounded-full bg-[#2b3036] hover:bg-[#323840] border border-white/10 text-white/80 hover:text-white transition-colors"
        >
            ...
            <AnimatePresence mode="wait">
              {user ? (
                ...
                >
                  <Link
                    to="/login"
                    className="relative px-3 sm:px-4 md:px-5 py-2 sm:py-2 text-white/90 hover:text-white transition-all duration-300 group rounded-full bg-white/5 ring-1 ring-white/10 hover:ring-white/20 shadow-sm hover:shadow-white/10 backdrop-blur-sm"
                  >
