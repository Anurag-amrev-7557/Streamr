import React, { useState, useEffect, useRef, useCallback, useMemo, useTransition, useDeferredValue, useLayoutEffect } from 'react';
    ...
    <header className="relative z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#2b3036] px-2 pl-4 py-3 bg-gradient-to-b from-[#23272F]/90 via-[#181A20]/80 to-[#181A20]/70 backdrop-blur-[10px] shadow-xl shadow-black/10 transition-all duration-500">
      ...
      <div className="flex items-center justify-end gap-3 sm:hidden">
        ...
        {user ? (
          <motion.button
            onClick={() => setIsMenuOpen(!isMenuOpen)}
            className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/15 flex items-center justify-center text-white font-medium text-sm transition-all duration-200"
