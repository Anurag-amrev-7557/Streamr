...
const NetworkStatus = () => {
  ...
  useEffect(() => {
    ...
    // Test network periodically (less frequent in prod; only when tab visible)
    const intervalMs = (import.meta && import.meta.env && import.meta.env.DEV) ? 10000 : 60000;
    ...
    // Update network stats periodically (less frequent in prod; only when tab visible)
    const statsIntervalMs = (import.meta && import.meta.env && import.meta.env.DEV) ? 5000 : 30000;
