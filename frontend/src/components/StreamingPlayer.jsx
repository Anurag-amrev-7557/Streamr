...
const StreamingPlayer = ({ 
      ...
      if (container && container.parentNode) {
        try {
          ...
          try {
            ...
            console.warn('[StreamingPlayer] Fallback portal removal also failed:', fallbackError);
          }
        }
      }
    };
  ...
  }, [currentProgress, lastProgressUpdate, content, updateProgress]);

  const saveProgress = useCallback(() => {
    if (currentProgress > 0 && content) {
