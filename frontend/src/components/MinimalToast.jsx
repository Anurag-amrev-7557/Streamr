...
import { PORTAL_CONFIGS } from '../utils/portalUtils';
...
const MinimalToast = (props) => {
  // Enhanced portal management for toast notifications
  const {
    container: portalContainer,
    createPortal: createPortalContent,
    isReady: portalReady
  } = usePortal('minimal-toast-portal', {
    ...PORTAL_CONFIGS.TOAST
  });
  ...
  return createPortalContent(<MinimalToastContent {...props} />);
};
