...
const Layout = () => {
  ...
  useEffect(() => {
    ...
    if (mediaQuery) {
      if (typeof mediaQuery.addEventListener === 'function') {
        mediaQuery.addEventListener('change', updateHints);
      } else if (typeof mediaQuery.addListener === 'function') {
        mediaQuery.addListener(updateHints);
      }
    }
    ...
    return () => {
      if (mediaQuery) {
        if (typeof mediaQuery.removeEventListener === 'function') {
          mediaQuery.removeEventListener('change', updateHints);
        } else if (typeof mediaQuery.removeListener === 'function') {
          mediaQuery.removeListener(updateHints);
        }
      }
  ...
  }, [lowEndDevice, saveData, prefersReducedMotion]);
  ...
  const reducedMotionSetting = (prefersReducedMotion || lowEndDevice || saveData) ? 'always' : 'never';
