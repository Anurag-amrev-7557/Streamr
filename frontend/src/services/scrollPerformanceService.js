...
class ScrollPerformanceService {
  ...
  calculatePerformanceMetrics() {
    ...
    const smoothRatio = this.metrics.smoothFrames / (this.metrics.smoothFrames + this.metrics.jankFrames);
    const frameRateScore = Math.min(this.metrics.frameRate / 60, 1) * 100;
    this.metrics.performanceScore = (smoothRatio * 0.7 + frameRateScore * 0.3 / 100) * 100;
