...
class EnhancedLoadingService {
  ...
  getErrorMessage(error, context = '') {
    // Handle cases where error might be undefined, null, or a string
    if (!error) {
      return `Failed to load ${context}. Please try again.`;
    }
    
    // If error is a string, return it directly or wrap it
    ...
    // Safely check error.message with fallback
