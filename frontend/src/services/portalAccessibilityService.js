...
class PortalAccessibilityService {
  ...
  detectUserPreferences() {
    // Detect reduced motion preference - DISABLED to enable animations on mobile
    // Force reducedMotion to false
    this.reducedMotion = false;
    
    // Removed reduced motion media query listener to always enable animations
  ...
  setupPortalAttributes(container, options = {}) {
    ...
    // Removed reduced motion class to enable animations on all devices
  ...
  updateReducedMotionStyles() {
    // Disabled - always enable animations on all devices
    // const containers = document.querySelectorAll('.portal-accessible');
    // containers.forEach(container => {
