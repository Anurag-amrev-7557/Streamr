...
class PerformanceOptimizationService {
  constructor() {
    this.config = {
      ...
      // Loading strategies - Optimized for faster loading
      maxConcurrentRequests: 5, // Increased from 3 to 5 for faster loading
      requestTimeout: 6000, // Reduced from 8 to 6 seconds for faster failure detection
      batchDelay: 200, // Reduced from 1000 to 200ms for faster loading
      idleDelay: 500, // Reduced from 5000 to 500ms for faster loading of low priority content
