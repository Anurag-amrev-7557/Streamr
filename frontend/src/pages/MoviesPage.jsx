...
const MoviesPage = () => {
  ...
  }, [window.location.search, genres, activeCategory, selectedGenre, selectedYear]); // FIXED: Removed handleCategoryChange dependency to prevent infinite loop
            ...
            <motion.div
              ...
              >
                {displayMovies.map((item, index) => {
                  ...
                  // Render CollectionCard for collections category
                  if (activeCategory === 'collections') {
                    return (
                      <CollectionCard
