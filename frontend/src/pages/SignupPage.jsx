          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div>
              ...
              <input
                ...
                onBlur={handleBlur}
                required
                className={`w-full bg-[#23272F] text-white rounded-full px-4 py-3 focus:outline-none focus:ring-2 focus:ring-white border transition-all duration-200 text-base sm:text-lg h-12 ${
            ...
            <div className="flex flex-row items-center gap-2 w-full">
              <input
                ...
                onChange={handleChange}
                className="form-checkbox rounded-full border-white/20 bg-[#23272F] focus:ring-white"
              />
