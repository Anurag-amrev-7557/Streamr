  ...
  return (
    <div className="min-h-screen bg-[#0f1114] text-white flex items-center justify-center px-2 sm:px-0">
      <div className="w-full max-w-md mx-auto px-2 sm:px-6 py-8 sm:py-12 flex flex-col items-center">
        ...
        >
          {error && (
            <div className="mb-4 p-3 bg-red-100 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-lg text-red-600 dark:text-red-400 text-sm">
              {error}
            </div>
          )}

          {sessionWarning && (
            <div className="mb-4 p-3 bg-yellow-100 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/20 rounded-lg text-yellow-700 dark:text-yellow-400 text-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div>
              ...
              <input
                ...
                onBlur={handleBlur}
                required
                className={`w-full bg-[#23272F] text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-white border transition-all duration-200 text-base sm:text-lg ${
            ...
            <div className="flex flex-row items-center justify-between gap-2 w-full">
              <label className="flex items-center gap-2 text-white/80 text-xs sm:text-sm">
                <input
                  ...
                  onChange={handleChange}
                  className="form-checkbox rounded border-white/40 bg-[#23272F] focus:ring-white"
                />
                Remember me
              </label>
