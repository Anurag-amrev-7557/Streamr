...
const WatchlistPage = () => {
  ...
  // Enhanced view transition system with:
  // - Shared layout animations using layoutId for seamless card-to-list transitions
  // - Precise image dimension changes from card aspect ratio to list thumbnail
  // - Smooth content repositioning to the right of images in list view
  // - Optimized timing and easing for visual appeal
  // - Transition state management to prevent jarring changes
  // - Visual feedback during view mode changes
      ...
      <div className="container mx-auto px-3 sm:px-6 py-4 sm:py-8">
        ...
        {!user && showLoginBanner && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="mb-6 transparent border border-white/15 rounded-xl p-4 backdrop-blur-sm shadow-lg"
          >
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-2">
                  <motion.button
                    ...
                    className="px-4 py-2 bg-white text-black hover:bg-white/90 text-sm font-medium rounded-full transition-colors"
                  >
                    Sign In
                  </motion.button>
                  <motion.button
                    ...
                    className="px-4 py-2 bg-transparent border border-white/30 hover:border-white/60 text-white/80 hover:text-white text-sm font-medium rounded-full transition-colors"
                  >
                    Dismiss
                  </motion.button>
                </div>
            ...
            <div className="flex items-center gap-2 sm:hidden">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`relative px-4 py-2 text-sm font-medium transition-all duration-200 transform-gpu will-change-transform ${
                    viewMode === 'grid' ? 'text-white' : 'text-white/50 hover:text-white/70'
                ...
                >
                  ...
                  {viewMode === 'grid' && (
                    <motion.div
                      layoutId="watchlistViewToggleUnderline"
                ...
                <button
                  ...
                  className={`relative px-4 py-2 text-sm font-medium transition-all duration-200 ${
                    viewMode === 'list' ? 'text-white' : 'text-white/50 hover:text-white/70'
                  } ${isTransitioning ? 'opacity-50 cursor-not-allowed' : ''}`}
                  title="List View"
                  type="button"
                  disabled={isTransitioning}
              ...
              {filteredWatchlist.length > 0 && (
                <motion.button
                  ...
                  className="relative px-3 py-2 rounded-full font-medium text-sm transition-colors duration-200 shadow-sm overflow-hidden focus:outline-none bg-[#1a1d21] text-gray-400 hover:text-black hover:bg-white flex-shrink-0 group"
                  style={{ minWidth: 80 }}
                  whileHover={{ scale: 1.02 }}
                ...
                >
                  ...
                  <span className="relative z-10 group-hover:text-black transition-colors duration-200">{getClearLabel()}</span>
                </motion.button>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-2 w-full sm:w-auto">
            ...
            <div className="hidden sm:flex">
              {filteredWatchlist.length > 0 && (
                <motion.button
                  onClick={() => setShowClearDialog(true)}
                  className="relative px-4 py-2.5 rounded-full font-medium text-sm transition-colors duration-200 shadow-sm overflow-hidden focus:outline-none bg-[#1a1d21] text-gray-400 hover:text-black hover:bg-white flex-shrink-0 ml-2 group"
                  style={{ minWidth: 90 }}
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.2 }}
                >
                  ...
                  >
                    ...
                    <div className="relative w-full h-full">
                      ...
                      <img
                        ...
                        alt={movie.title}
                        className={`w-full h-full object-cover transition-all duration-300 group-hover:scale-110 md:group-hover:brightness-105 ${
              ...
              >
                {filteredWatchlist.map((movie, index) => (
                  <motion.div
                    ...
                    className="bg-[#1a1d21] rounded-lg overflow-hidden cursor-pointer group relative transform-gpu transition-all duration-300 hover:scale-[1.005] hover:shadow-xl hover:shadow-black/20 hover:ring-1 hover:ring-white/10 h-20 sm:h-24 origin-top-right"
                    onClick={() => handleMovieSelect(movie)}
                  >
                    <div className="flex h-full">
                      ...
                      <div className="w-32 h-20 sm:w-36 sm:h-24 flex-shrink-0 relative p-2">
                        {!loadedImages[movie.id] && (
                          <div className="absolute inset-2 bg-[#22262b] rounded" />
                        )}
                        <img
