...
export const testIframeProgress = () => {
  ...
  const testUrls = [
    ...
    'https://rivestream.net/embed?type=movie&id=tt0111161&t=3600',
    'https://cinemaos.tech/player/tt0111161?time=1800',
  ...
  const testServiceUrls = [
    ...
    'https://rivestream.net/embed?type=movie&id=tt0111161',
    'https://cinemaos.tech/player/tt0111161'
  ];
